-- Migration: Instruction-Based Agent Execution System
-- Date: 2024-02-22
...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_execution_logs_execution_id ON execution_logs(agent_execution_id);
CREATE INDEX IF NOT EXISTS idx_execution_logs_created_at ON execution_logs(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_execution_logs_type ON execution_logs(agent_execution_id, log_type);
